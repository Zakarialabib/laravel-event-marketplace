<div>
    <div x-data="{ openNotification: false }">
        ...
        <div x-show="openNotification" x-transition:enter="transition ease-out duration-300 transform"
            ...
            @click.away="openNotification = false" class="absolute h-auto right-0 top-0 mt-12 w-96 bg-white shadow-lg p-4 overflow-y-auto overflow-x-hidden">
            ...
            <div class="w-full p-3 mt-4 bg-white rounded shadow flex flex-shrink-0">
                ...
                <div class="pl-3 w-full">
                    <div class="flex items-center justify-between w-full">
                        ...
                        <div wire:click="markAsRead('{{ $notification->id }}')" tabindex="0" aria-label="close icon" role="button" class="focus:outline-none cursor-pointer">
