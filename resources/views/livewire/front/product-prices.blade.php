                    ...
                    <div class="overflow-y-scroll h-[25rem]">
                        @forelse ($results as $store)
                            <div class="flex items-center px-4 py-3 border-b border-gray-200"
                                ...
                                <div class="flex-grow">
                                    <h4 class="text-md font-bold text-green-400">{{ $store->name }}</h4>
                                    {{-- <p class="text-sm text-gray-500">{{ $store->location }}</p> --}}
                                </div>
                                <div class="flex-none">
                                    <a href=""
                                        class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg inline-flex items-center">
                        ...
                        @empty
                            <div
                                class="flex-none px-4 py-2 text-center text-white hover:text-green-700 items-center">
