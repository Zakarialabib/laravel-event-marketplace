<div>
    <div x-data="{ showCart: false }"
        class="fixed bg-white pointer top-36 right-0 z-50 transition duration-150 ease-in-out bg-opacity-75 py-4 px-5 rounded-l-lg">
        @if (Cart::count() > 0)
            <button x-on:click="showCart = true" type="button" class="flex items-center relative py-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="text-green-800" width="30" height="30">
