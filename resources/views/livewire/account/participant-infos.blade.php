    ...
    <form wire:submit.prevent="save">
        <div class="grid xl:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-4 items-cente">
            <div>
                ...
                <x-input wire:model.defer="participant.email" required id="email" name="email"
            ...
            <div>
                ...
                <x-input wire:model.defer="participant.name" required type="text" id="name"
            ...
            <div>
                ...
                <x-input wire:model.defer="participant.country" type="text" required id="country"
                    name="country" />
            ...
            <div>
                ...
                <x-input wire:model.defer="participant.city" required type="text" id="city"
                    name="city" />
                <x-input-error :messages="$errors->get('participant.city')" for="participant.city" class="mt-2" />
            </div>
            <div>
                <x-label for="zip_code" :value="__('Zip code')" />
                <x-input wire:model.defer="participant.zip_code" type="text" id="zip_code"
                    name="zip_code" />
            ...
            <div>
                ...
                <x-input wire:model.defer="participant.emergency_contact_name"
            ...
            <div class="col-span-full">
                ...
                <x-input wire:model.defer="participant.address" type="text" required id="address"
                    name="address" />
        ...
        <div class="w-full flex flex-wrap py-6 justify-between gap-4">
            <div class="w-full">
                ...
                <textarea wire:model.defer="participant.health_informations" name="" id="" rows="5"
