<div>
    @section('title', __('Participant Details'))
    <section class="py-3 px-4">
        <div class="flex flex-wrap items-center justify-between">
            <div class="mb-5 lg:mb-0">
                <h4 class="mb-1 text-2xl font-bold">
                    {{  __('Participant Details') }} - {{ $participant->name }}
                </h4>
                <div class="flex items-center">
                    ...
                    <a class="flex items-center text-sm" href="{{ URL::Current() }}">
                        ...
                        <span>{{ __('Participant Details') }}</span>
                    </a>
                </div>
            </div>
    ...
    <div class="w-full py-10 mx-4 mt-12 flex bg-white" x-data="{ activeTab: 'participation' }">
        <div class="w-1/4">
        ...
        <div class="w-3/4 px-6 pb-6">
            <div x-show="activeTab === 'participation'" class="w-full">
                <h2 class="text-2xl font-bold font-heading text-gray-700 mb-4">
                    {{ $participant->name }} - {{ __('Participant Information') }}
                </h2>
                ...
                <div class="relative w-full">
                    <ul class="py-10 mt-6 border-t border-gray-200">
                        ...
                        <li>
                            <p>
                                {{ __('Gender') }}: {{ $participant->gender }}
                            </p>
                        </li>
                        <li>
                            <p>
                                {{ __('Country') }}: {{ $participant->country }}
                            </p>
                        </li>
                        <li>
                            <p>
                                {{ __('City') }}: {{ $participant->city }}
                            </p>
                        </li>
                        <li>
                            <p>
                        ...
                        <li>
                            <p>
                                {{ __('Address') }}: {{ $participant->address }}
                            </p>
                        </li>
                        <li>
                            <p>
                        ...
                        <li>
                            <p>
                                {{ __('Health Informations') }}: {{ $participant->health_informations }}
                            </p>
                        </li>
                        <li>
                            <p>
                                {{ __('Medical History') }}: {{ $participant->medical_history }}
                            </p>
                        </li>
                        <li>
                            <p>
                                {{ __('Taking Medications') }}: {{ $participant->taking_medications }}
                            </p>
                        </li>
                        <li>
                            <p>
                                {{ __('Medication Allergies') }}: {{ $participant->medication_allergies }}

                        <li>
                            <p>
                                {{ __('Sensitivities') }}: {{ $participant->sensitivities }}
                            </p>
                        </li>
                    </ul>
                </div>
