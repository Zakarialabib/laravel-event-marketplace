        ...
        <div class="flex flex-wrap items-center justify-between">
            <div class="mb-5 lg:mb-0">
                <h4 class="mb-1 text-2xl font-bold">
                    {{ __('Update translations for') }} {{ $language->name }}
                </h4>
                ...
                @foreach ($translations as $key => $translation)
                    <x-table.tr>
                        ...
                        <x-table.td>
                            ...
                            wire:model.lazy="translations.{{ $key }}.value" >
                            </textarea>
                            @error('translations.'.$key.'.value') <span class="text-danger">{{ $message }}</span> @enderror
                        </x-table.td>
                        <x-table.td>
