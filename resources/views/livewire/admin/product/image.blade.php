            ...
            <form wire:submit.prevent="saveImage">
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full px-4 my-2">
                        ...
                        <textarea id="embeded_video" class="block mt-1 w-full" type="text" name="embeded_video" wire:model="embeded_video">
                        </textarea>
                    ...
                    <div class="w-full px-4 my-2">
                        ...
                        <x-media-upload title="{{ __('Product Image') }}" name="image" wire:model="image"
                            :file="$image" :preview="$this->imagepreview" single types="PNG / JPEG / WEBP" fileTypes="image/*" />
                    </div>
