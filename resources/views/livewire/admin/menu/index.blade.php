        ...
        <div class="flex flex-wrap">
            <div class="w-1/4 p-4 ">
                ...
                <x-theme.accordion title="Add Menu">
                    <form wire:submit.prevent="store" class="grid grid-cols gap-2 px-4">
                        ...
                        <div class="w-full">
                            ...
                            <select id="parent_id"
                                class="border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 block w-full sm:text-sm rounded-md mt-1"
                                name="parent_id" wire:model.defer="parent_id">
                                <option></option>
                ...
                <x-theme.accordion title="Clone Menu">
                    <form wire:submit.prevent="clone" class="grid grid-cols gap-2 px-4">

                        <div class="w-full">
                            <x-label for="selectedMenu" :value="__('Menus')" required />
                            <select id="selectedMenu" required name="selectedMenu" wire:model.defer="selectedMenu"
                                class="border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 block w-full sm:text-sm rounded-md mt-1">
                        ...
                        <div class="w-full">
                            <x-label for="placement" :value="__('Placement')" required />
                            <select id="menuPlacement" required name="menuPlacement" wire:model.defer="placement"
                                class="border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 block w-full sm:text-sm rounded-md mt-1">
                                <option value="">{{ __('Select Placement') }}</option>
                                @foreach (\App\Enums\MenuPlacement::values() as $key => $value)
                                    <option value="{{ $key }}"
            ...
            <div class="w-3/4 p-4" x-data="{ sortable: null }" x-init="sortable = new Sortable($refs.menuList, {
                ...
                <div class="flex flex-wrap justify-center gap-4 mb-4">
                    @foreach (\App\Enums\MenuPlacement::values() as $key => $value)
                        <x-button type="button" wire:click="filterByPlacement('{{ $key }}')"
                            :class="$placement === $key
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div class="w-full">
                                            ...
                                            <x-input id="name{{ $index }}" class="block mt-1 w-full" required
                                                type="text" name="name"
                                                wire:model.defer="menus.{{ $index }}.name" />
                                        ...
                                        <div class="w-full">
                                            ...
                                            <select id="type{{ $index }}" required
                                                class="border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 block w-full sm:text-sm rounded-md mt-1"
                                                name="type" wire:model.defer="menus.{{ $index }}.type">
                                                <option value="">{{ __('Select Type') }}</option>
                                                @foreach (\App\Enums\MenuType::values() as $key => $value)
                                                    <option value="{{ $key }}"
                                        ...
                                        <div class="w-full">
                                            ...
                                            <select id="placement{{ $index }}" required
                                                class="border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 block w-full sm:text-sm rounded-md mt-1"
                                                name="placement" wire:model.defer="menus.{{ $index }}.placement">
                                                <option value="">{{ __('Select Placement') }}</option>
                                                @foreach (\App\Enums\MenuPlacement::values() as $key => $value)
                                                    <option value="{{ $key }}"
                                        ...
                                        <div class="w-full">
                                            ...
                                            <x-input id="label{{ $index }}" class="block mt-1 w-full" required
                                                ...
                                                wire:model.defer="menus.{{ $index }}.label" />
                                        ...
                                        <div class="relative w-full" x-data="{ isOpenLinks: false }">
                                            ...
                                            <div class="relative">
                                                <x-input id="label{{ $index }}" class="block mt-1 w-full"
                                                    required type="text" name="label{{ $index }}"
                                                    x-ref="url" wire:model.defer="menus.{{ $index }}.url" />
                                                <div
                                        ...
                                        <div class="w-full">
                                            ...
                                            <select id="parent_id{{ $index }}"
                                                class="border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 block w-full sm:text-sm rounded-md mt-1"
                                                name="parent_id" wire:model.defer="menus.{{ $index }}.parent_id">
                                                <option></option>
                                                @foreach ($this->menus as $menuItem)
                                        ...
                                        <div class="w-full">
                                            ...
                                            <label class="flex items-center mt-2">
                                                <input id="new_window{{ $index }}" name="new_window"
                                                    type="checkbox" class="form-checkbox" wire:model.defer="new_window">
                                                <span class="ml-2">{{ __('New Window') }}</span>
                                            </label>
                                            <x-input-error :messages="$errors->get('menu.new_window')" for="new_window" class="mt-2" />
                                        </div>
                                        <p class="float-right">
                                            <x-button type="button" wire:click="update({{ $menu['id'] }}, {{ $index}})"
