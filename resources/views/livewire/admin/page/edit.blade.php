            ...
            <form wire:submit.prevent="update">
                <div class="flex flex-wrap space-y-2 px-2">
                    ...
                    <div class="lg:w-1/2 sm:w-full px-2">
                        ...
                        <x-input wire:model="page.title" type="text" id="title" required />
                    </div>
                    <div class="lg:w-1/2 sm:w-full px-2">
                        <x-label for="slug" :value="__('Slug')" required />
                        <x-input wire:model="page.slug" type="text" id="slug" disabled />
                    </div>

                    <div class="w-full px-2">
                        <x-label for="description" :value="__('Description')" />
                        <x-trix name="descriptionPage" wire:model="description" />
                    </div>
