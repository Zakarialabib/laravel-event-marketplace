<section class="pt-10 pb-5 px-10 bg-gray-900 mx-auto">
        ...
        <div class="w-full lg:w-3/5 px-4 mb-10">
            <div class="flex flex-wrap -mx-4">
                <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-10 lg:mb-0">
                    <h3 class="mb-8 text-xl font-bold font-heading text-white border-b border-move-400">
                        {{ __('Information') }}</h3>
                    <ul>
                        <li class="mb-6"><a class="text-white hover:text-move-400 hover:underline" href="#">
                                {{ __('Blog') }}
                            </a>
                        </li>
                        <li>
                            <a class="text-white hover:text-move-400 hover:underline"
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-4">
                    <h3 class="mb-8 text-xl text-white font-bold font-heading border-b border-move-400">
                        {{ __('Contact Us') }}</h3>
                    <ul>
                        <li class="mb-6">
                        ...
                        <li>
                            ...
                            <a class="text-white hover:text-move-400 hover:underline" href="#" target="_blank">
            ...
            <div class="w-full flex flex-wrap lg:justify-between sm:justify-center mb-4">
                <div class="w-full md:w-auto flex justify-center items-center gap-4">
                    <a class="inline-flex w-12 h-12"
                        ...
                        <i class="fab fa-facebook-f text-xl text-white hover:text-move-200 transition"></i>
                    </a>
                    <a class="inline-flex w-12 h-12"
                        href="{{ Helpers::settings('social_instagram') }}" target="_blank">
                        <i class="fab fa-instagram text-xl text-white hover:text-move-200 transition"></i>
                    </a>
                    <a class="inline-flex w-12 h-12"
                        href="{{ Helpers::settings('social_twitter') }}" target="_blank">
                        <i class="fab fa-twitter text-xl text-white hover:text-move-200 transition"></i>
                    </a>
                    <a class="inline-flex w-12 h-12"
                        href="{{ Helpers::settings('social_linkedin') }}" target="_blank">
                        <i class="fab fa-linkedin-in text-xl text-white hover:text-move-200 transition"></i>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="pt-5 flex items-center justify-center">
        <p class="inline-block text-sm text-gray-200">
            <a class="uppercase hover:text-move-500" href="https://behance.net/zakarialabib" target="_blank">handcrafted
                by zakaria labib</a>
        </p>
    </div>
</section>
