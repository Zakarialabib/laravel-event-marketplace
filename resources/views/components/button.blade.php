...
@php
    $classes =
        ($primary ? 'bg-move-600 border border-transparent text-white hover:bg-move-600 focus:ring-move-500 active:bg-move-900 focus:outline-none focus:border-move-900' : '') .
        ...
        ($primaryOutline ? 'bg-transparent border border-move-500 text-move-500 hover:bg-move-500 hover:text-white active:bg-move-900 focus:outline-none focus:border-move-900 focus:ring ring-move-300' : '') .
