<div x-data="{ isSidebar: false }" class="relative">
    <header x-data="{ isSticky: true }" x-init="window.addEventListener('scroll', () => {
        ...
        class="w-full top-4 transition-opacity duration-300"
        x-transition:enter="transition-transform ease-in-out duration-800 transform"
        x-transition:enter-start="-translate-y-full"
        x-transition:enter-end="translate-y-0"
        x-transition:leave="transition-transform ease-in-out duration-800 transform"
                ...
                <div class="basis-full px-3.5">
                    <div class="bg-white h-18 rounded-xl px-10 relative z-[1] drop-shadow-xl">
                        ...
                        <div class="items-center flex flex-wrap justify-start">
                            ...
                            <ul class="items-center flex ml-5 float-right">
                                <li class="list-item md:flex gap-4">
                                    @if (Auth::check())
                                ...
                                <li class="list-item">
                                    <button type="button" class="self-center ml-4 mr-8 md:hidden"
            ...
            <div class="fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50 overflow-y-scroll" x-show="isSidebar"
                ...
                <nav class="relative flex flex-col py-6 px-6 w-full h-full bg-white border-r overflow-y-scroll">
                    <div class="flex items-center mb-2">
                        <a class="mr-auto lg:text-3xl sm:text-xl font-bold font-heading"
