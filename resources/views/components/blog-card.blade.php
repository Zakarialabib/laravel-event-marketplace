@props(['blog'])
<div class="flex flex-col items-center py-4 px-2 border-green-300 border rounded-2xl">
    <a href="{{ route('front.blogPage', $blog->slug) }}" class="cursor-pointer my-auto py-10">
        ...
        <h3 class="text-[2.50rem] leading-none font-bold mb-4">{{ $blog->title }}</h3>
        <p class="text-lg mb-11">
            {!! $blog->description !!}
        </p>
