...
class InvalidConfiguration extends Exception
{
    ...
    public static function attributeNotSpecified(string $attribute)
    {
        return new self(__('The :attribute has not been provided. Please provide it.', ['attribute' => $attribute]));
    }

    public static function attributeInvalidString(string $attribute)
    {
    ...
    public static function attributeInvalidUrl(string $attribute)
    {
